    ...
    <div id="one" class="section scrollspy">
      ...
      <div class="row">
        <div class="col s12 center">
          <h4>Some more information about the project:</h4>
        </div>
  ...
  <div id="second" class="row">
    <div class="col s12">
      ...
      <div class="container">
        <div class="row">
          <div class="col s12">
            <h5 id="crown" class="purple-text scrollspy">
              <div class="sahasrara"></div>Insufficient interest in present circumstances - <i>7) Sahasrara The Crown Chakra</i> - it’s associated with the universal, connection with spirituality, consciousness.
            </h5>
          ...
          <div class="col s12">
            <h5 id="thirdeye" class="indigo-text text-lighten-1  scrollspy">
              <div class="ajna"></div>For Those Who Suffer Uncertainty - <i>6) Ajna The Third Eye Chakra</i> - it evokes intuition, extrasensory perception, inner wisdom.
            </h5>
          ...
          <div class="col s12">
            <h5 id="throat" class="blue-text scrollspy">
              <div class="visudha"></div>Over-care for welfare of others - <i>5) Visudha The Throat Chakra</i> - it symbolizes self expression, expression of truth, creative expression, communication, perfect form and patterns.
            </h5>
          ...
          <div class="col s12">
            <h5 id="heart" class="green-text scrollspy">
              <div class="anahata"></div>Loneliness - <i>4) Anahata The Heart Chakra</i> - it is connected with love, relating, integration, compassion.
            </h5>
          ...
          <div class="col s12">
            <h5 id="solarplexus" class="yellow-text text-darken-3 scrollspy">
              <div class="manipura"></div>Despondency or despair - <i>3) Manipura The Solar Plexus Chakra</i> - it symbolizes mental activities, intellect, personal power, will.
            </h5>
          ...
          <div class="col s12">
            <h5 id="sacral" class="orange-text text-darken-4 scrollspy">
              <div class="svadhistana"></div>Over-sensitivity to influences and ideas - <i>2) Svadhistana The Sacral Chakra</i> - it carries meanings associated with emotions, creativity, sexuality, and is associated with water, flow.
            </h5>
          ...
          <div class="col s12">
            <h5 id="root" class="red-text text-darken-2 scrollspy">
              <div class="muladhara"></div>For Those Who Have Fear - <i>1) Muladhara The Root Chakra</i> - it symbolizes safety, survival, grounding, nourishment from the Earth energy.
            </h5>
